...
import com.example.instaapp.Fragments.ProfilePostFragment1
import com.example.instaapp.Fragments.ProfilePostFragment2
...
class ViewPagerAdapter(fragmentManager: FragmentManager,lifecycle: androidx.lifecycle.Lifecycle):FragmentStateAdapter(fragmentManager,lifecycle) {
    ...
    override fun createFragment(position: Int): Fragment {
        return if (position == 0)
            ProfilePostFragment1()
        else
            ProfilePostFragment2()
    }
}